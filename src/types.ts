...
export interface YearlyDetail { 
    ...
    amountInc: number; 
    losAmountInc?: number; // New: Breakdown for Service points
    rankAmountInc?: number; // New: Breakdown for Rank points
    evalAmountInc?: number; // New: Breakdown for Evaluation points
    totalPt: number;
    coef: number;
    accLosPt?: number;
    accRankPt?: number;
    accEvalPt?: number;
    accAdjustmentPt?: number;
}
...
export interface CalculationResult {
    ...
    totalLosPoints: number;
    totalRankPoints: number;
    totalEvalPoints: number;
...
export interface SimulationConfig {
    label: string;
    unitPrice: number;
    masterDataSource?: 'default' | 'custom' | 'manual';
